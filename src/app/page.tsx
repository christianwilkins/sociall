...
export default function Home() {
  ...
  const handleUpload = async (file: File) => {
    ...
    if (response.ok) {
      ...
      setContextText(data.description);
    } else {
  ...
  const setTemperatureToCreative = () => {
    setRadioValue(0.6);
    console.log("creative");
  }

  const setTemperatureToExperimental = () => {
    setRadioValue(0.9);
        ...
        <div className="flex justify-center w-full">
          ...
          >
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="default" id="r1" onClick={setTemperatureToDefault}/>
              <Label htmlFor="r1">Default</Label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="comfortable" id="r2" onClick={setTemperatureToCreative}/>
              <Label htmlFor="r2">Creative</Label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="compact" id="r3" onClick={setTemperatureToExperimental}/>
